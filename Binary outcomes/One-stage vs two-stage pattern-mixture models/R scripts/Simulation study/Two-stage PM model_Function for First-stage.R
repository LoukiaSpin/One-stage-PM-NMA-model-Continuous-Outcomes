################################################################################################################
#                                                                                                              #
#          Function to obtain within-trial log odds ratio and standard errors using the Taylor-series          # 
#                  Two-stage pattern-mixture model with informative missingness odds ratio                     #
